...
dicom-wsi could always use more documentation, whether as part of the
official dicom-wsi docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 2.7, 3.5, 3.6 and 3.7, and for PyPy. Check
   https://travis-ci.org/Steven-N-Hart/dicom_wsi/pull_requests
